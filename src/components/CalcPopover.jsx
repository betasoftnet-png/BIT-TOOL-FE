...
export function CalcPopover({ isInline = false, onCloseInline } = {}) {
    ...
    }, [open, isInline, activeInput, activeOp, tape, activeLabel]);
    ...
    const styles = {
        ...
        header: {
            padding: isInline ? '16px 24px' : '10px 16px',
        ...
        activeLine: {
            padding: isInline ? '20px 24px' : '8px 16px',
            background: 'linear-gradient(to right, #F8FAFC, #F1F5F9)',
            display: 'flex',
            flexDirection: 'column',
            justifyContent: 'center',
            minHeight: isInline ? '80px' : '52px',
        ...
        smartBar: {
            display: 'flex',
            justifyContent: 'space-between',
            padding: isInline ? '16px 24px' : '6px 12px',
            background: '#FFFFFF',
            borderBottom: '1px solid #F1F5F9',
